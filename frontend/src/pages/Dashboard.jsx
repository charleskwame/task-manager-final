...
function Dashboard() {
	const { taskData, updateTaskStatus, deleteTask, updateTaskDetails, addNewTask, isAuthorized } =
	...
	return (
		<>
			{isAuthorized ? (
				...
				<div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 gap-2 flex flex-col justify-center items-center">
					<h1 className="text-center text-lg text-violet-500 font-semibold">
						Authorization Revoked Due To Page Refresh
					</h1>
